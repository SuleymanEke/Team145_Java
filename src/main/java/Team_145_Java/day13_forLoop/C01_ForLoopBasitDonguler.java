...
public class C01_ForLoopBasitDonguler {
    public static void main(String[] args) {
        ...
        System.out.println("Iki basamakli cift sayilarin toplami: " + toplam);

        System.out.println();

        //40 sayisinin kalansiz bolebilen pozitif tam sayilari yazdirin
        for (int i = 1; i <= 40; i++) {
            if (40 % i == 0) {
                System.out.print(i + " ");
            }
        ...
        //verlen baslangic ve bitis degerleri dahil olmak uzere
        ...
        for (int i = baslangic; i <= bitis; i++) {
            ...
            System.out.println(baslangic + " ile " + bitis + " arasinda " + sayac + " adet 7 ile bolunebilen sayi var.");
